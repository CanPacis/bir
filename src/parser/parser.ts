...
const grammar: Grammar = {
  ...
  ParserRules: [
    ...
    {"name": "BlockDeclarationStatement", "symbols": ["identifier", "BlockDeclarationStatement$ebnf$1", "__", {"literal":"["}, "_", "BlockDeclarationStatement$ebnf$2", {"literal":"]"}, "_", "BlockContent"], "postprocess": d => ({ operation: "block_declaration", name: d[0], verbs: d[1], arguments: d[5], body: d[8], position: d[0].position, implementing: false })},
    {"name": "BlockDeclarationStatement", "symbols": ["identifier", "_", {"literal":"implements"}, "_", "identifier"], "postprocess": d => ({ operation: "block_declaration", name: d[0], implements: d[4], position: d[0].position, implementing: true })},
    {"name": "BlockVerb", "symbols": [{"literal":":"}, "identifier"], "postprocess": d => d[1]},
